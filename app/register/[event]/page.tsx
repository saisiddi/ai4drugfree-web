          ...
          <div className="rounded-3xl border border-orange-500/20 bg-black/40 p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)] backdrop-blur-md">
            ...
            <div className="mt-8 space-y-4 text-sm text-orange-100/70">
              <div className="flex justify-between border-b border-orange-500/10 pb-2">
                <span className="text-orange-400/50 uppercase tracking-[0.2em] text-[0.65rem]">Team Size</span>
                <span>{event.teamSize}</span>
              </div>
              <div className="flex justify-between border-b border-orange-500/10 pb-2">
                <span className="text-orange-400/50 uppercase tracking-[0.2em] text-[0.65rem]">Schedule</span>
                <span>{event.schedule}</span>
              </div>
              <div className="flex justify-between border-b border-orange-500/10 pb-2">
                <span className="text-orange-400/50 uppercase tracking-[0.2em] text-[0.65rem]">Venue</span>
